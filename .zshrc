...
# if [ $? -eq 0 ]; then
    # eval "$__conda_setup"
# else
    # if [ -f "/media/me/83829c82-12b7-44ed-8458-39aeb6ae16ea/anaconda/3/etc/profile.d/conda.sh" ]; then
        # . "/media/me/83829c82-12b7-44ed-8458-39aeb6ae16ea/anaconda/3/etc/profile.d/conda.sh"
    # else
        # export PATH="/media/me/83829c82-12b7-44ed-8458-39aeb6ae16ea/anaconda/3/bin:$PATH"
    # fi
# fi
# unset __conda_setup
# <<< conda initialize <<<
