...
:highlight Pmenu ctermbg=233 ctermfg=255
:highlight PmenuSel ctermbg=154 ctermfg=233
...
set hls
"define tabstop and shiftwidth to be 4 spaces
set ts=4 sw=4
...
"redefine <Leader> key (e.g. for nercommenter)
let mapleader=","
...
"switch between buffers with Ctrl+Tab
...
set wildignore+=*.DS_Store "Mac stuff
set wildignore+=*.git "git files
set wildignore+=*.m~,*.mex "autogenerated matlab files
...
""""""""""""""""""""""""""""""""""""""VUNDLE SETTINGS"""""""""""""""""""""""""""""""""""""""
" additions for Vundle
set nocompatible
filetype off
set rtp+=~/.vim/bundle/Vundle.vim
call vundle#begin()
Plugin 'gmarik/Vundle.vim' "required
" add additional vundle plugins here

" Python autocomplete (obsolete due to youcompleteme)
" Plugin 'davidhalter/jedi-vim'

" Autocomplete for C/Python
Plugin 'Valloric/YouCompleteMe'

" python support (virtualenv,sytax,indentation etc.)
"Plugin 'klen/python-mode'

" Sublime like Cursor modes (multiple selections)
Plugin 'terryma/vim-multiple-cursors'

" Show indent by color bars
Plugin 'nathanaelkane/vim-indent-guides'

" Provides rgb color space in vim
Plugin 'guns/xterm-color-table.vim'

" Provides git integration
Plugin 'tpope/vim-fugitive'

" provides - and + in gutter column to show what has been added based on git
Plugin 'airblade/vim-gitgutter'

" provides directory tree
Plugin 'scrooloose/nerdtree'

" Provides comment shortcuts
...
" rename file within vim and on disk
Plugin 'danro/rename.vim'

" align equations on =
Plugin 'vim-scripts/Align'

" provides folding and indent of .m files
Plugin 'djoshea/vim-matlab-fold'

" fuzzy search
Plugin 'ctrlpvim/ctrlp.vim'

" provides fancy symbols to other plugins
Plugin 'ryanoasis/vim-devicons'

" precview for subsitution
Plugin 'osyo-manga/vim-over'

" Fancy status line symbols + themes
Plugin 'vim-airline/vim-airline'
Plugin 'vim-airline/vim-airline-themes'

" Plugin for coloring matching (){}[]
Plugin 'luochen1990/rainbow'

" Plugin for switching between source and header
...
"OSYO-MANGA SUBSTITUTE HILIGHTING
let g:over_enable_auto_hohlsearch = 1
